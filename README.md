...
2. Khi Colab in URL `https://….gradio.live` ở ô cuối, mở URL đó; **không cần tài khoản hoặc mật khẩu**. Giao diện có text-to-image, img2img, tô hoặc tải mask PNG để inpaint, prompt/negative, kích thước, steps, CFG, seed, strength, số ảnh, cường độ LoRA đã nạp và nút tải PNG.
